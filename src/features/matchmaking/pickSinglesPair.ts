 ...
 * 1. Smallest skill gap.
 * 2. Among those, prefer a same-gender pairing over a mixed one (male/female-only
 *    means "mixed" is the one case to avoid when an alternative exists).
 * 3. Among those, prefer opponents who haven't played each other yet, falling back
